...
//         if (user.role === "TENANT") {
//             res.status(200).json({ message: "You are already an TENANT" });
//             return;
//         }
...
//         res.status(200).json({ message: "Your role has been updated to TENANT. You can now access the Create Event page." });
//     } catch (error) {
